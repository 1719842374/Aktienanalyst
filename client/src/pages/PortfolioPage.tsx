 ...
 *
 * 12.09.2026: Restore nach Placeholder-Unfall in 2d79ae4 (SEE_ARTIFACTS_Page).
 * Quelle: 08e8938. Einziger Patch: Default-Timeframe 6M -> 1Y (WORK.md_portfolio_3).
 */
...
export default function PortfolioPage() {
  ...
  const [timeframe, setTimeframe] = useState<TimeframeFilter>("1Y");
