// Auto-generated fallback data for static deployment (no backend)
// Generated: 2026-04-08T21:25:00Z
...
export const RECESSION_FALLBACK_DATA = {
  ...
  "indicators": [
    ...
    },
    {
      ...
      "weightedScore": 0,
      "maxWeighted": 11.9,
      "zone": "Normal (49.5 30-60)",
      "source": "Google Trends (7d Ø=49.5, Latest=42, Peak=100)",
  ...
  "subgroups": [
    ...
    },
    {
      ...
      "maxScore": 28.6,
      "probability": 65,
      "formula": "50% + (8.2/28.6) × 50% = 64.3% → 65%"
    },
    {
      ...
      "maxScore": 73.1,
      "probability": 80,
      "formula": "50% + (40.8/73.1) × 50% = 77.9% → 80%"
    }
  ],
  "nyFedValue": 0.48,
  ...
  "topDrivers": [
    ...
    "Shiller CAPE: +12.6 (Extrem hoch (38.1 >35))",
  ...
  "fazit": {
    "summary": "Gesamtbewertung: Hoches Risiko. Rezession 12M: 25%, Korrektur 12M: 80%. Die Kombination aus historisch extremen Bewertungen (Buffett 230%, CAPE 38.1), dem Iran/Hormuz-Ölpreisschock mit Stagflationspotenzial, und systemischen Risiken im $3T-Private-Credit-Markt bildet ein Dreifach-Risiko-Cluster, das defensives Portfoliomanagement erfordert.",
    "riskLevel": "Hoch",
    "sections": [
      {
        "title": "Quantitative Bewertung",
        "emoji": "📊",
        "text": "Von 17 Indikatoren signalisieren 9 ein erhöhtes Risiko (bearish), 5 sind positiv (bullish) und 3 neutral. Die Rezessionswahrscheinlichkeit liegt bei 10% (3M), 20% (6M) und 25% (12M). Die Korrekturwahrscheinlichkeit beträgt 65% (Sentiment, 3-6M) und 80% (Vollständig, 12M). Die hohe Korrekturwahrscheinlichkeit von 80% wird maßgeblich durch extreme Bewertungsniveaus getrieben: Buffett Indikator (TMC/GDP): +16 (Extrem überbewertet (230% >200%)); Shiller CAPE: +12.6 (Extrem hoch (38.1 >35)); Margin Debt: +4 (Erhöht / Überbewertet)."
      },
      {
        "title": "Bewertungsrisiko",
        "emoji": "⚠️",
        "text": "Der Buffett-Indikator steht bei 230% — das höchste Niveau seit der Dotcom-Blase. Historisch führten Bewertungen über 200% zu durchschnittlichen Drawdowns von 30-50% innerhalb von 18 Monaten. Das Shiller CAPE-Ratio von 38.1 liegt über dem Durchschnitt der letzten 140 Jahre (ca. 17) und signalisiert, dass zukünftige Aktienrenditen (10J) mit hoher Wahrscheinlichkeit unterdurchschnittlich ausfallen. Die NYSE Margin Debt ($2025T) zeigt erhöhte Hebelwirkung im Markt — ein klassischer Vorlauf-Indikator für abrupte Sell-Offs."
      },
      {
