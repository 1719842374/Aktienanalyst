...
import { fetchSecRpo } from "./sec-segments";
...
export async function registerRoutes(httpServer: Server, app: Express): Promise<void> {
  ...
  app.post("/api/thesis-strength", async (req, res) => {
    try {
      ...
      const [incomeRows, cashflowRows, balanceRows, rawPeers, analystEstimates, secRpo] = await Promise.all([
